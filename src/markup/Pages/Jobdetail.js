							...
							<div className="row">
								...
								<div className="col-lg-8 m-b10">
									<div className="job-info-box">
										...
										<div className="dez-divider divider-2px bg-gray-dark mb-4 mt-0"></div>
										<p>Create an account by completing the registration process. Once registered, log in to your account using your credentials.Update your candidate profile by filling in all required fields, including personal details, educational qualifications, skills, and uploading your resume. A complete profile ensures you can apply for jobs seamlessly.Make sure your profile is up-to-date to increase your chances of getting shortlisted.Browse through the available job listings and click on the Apply button for the roles that match your skills and qualifications.</p>
